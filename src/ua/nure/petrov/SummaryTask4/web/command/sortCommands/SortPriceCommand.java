...
/**
 * Sort tariffs by price command
 * 
 * @author Petrov Vladyslav
 *
 */
public class SortPriceCommand extends Command {

	private static final long serialVersionUID = -3071536593627692473L;

	private static final Logger LOG = Logger.getLogger(SortPriceCommand.class);
	...
	public String execute(HttpServletRequest request,
		...
		if (flag == 1) {
			Collections.sort(sortedTariffs, CompareTariffs.SORT_BY_PRICE);
			flag = 0;
		} else {
			Collections.sort(sortedTariffs, CompareTariffs.SORT_BY_PRICE_REVERSE);
			flag = 1;
		}
